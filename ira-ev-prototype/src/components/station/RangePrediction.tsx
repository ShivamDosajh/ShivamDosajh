...
export function RangePrediction({ currentRange, arrivalRange }: RangePredictionProps) {
  return (
    <div className="w-full rounded-card bg-surfaceInset border border-border px-3.5 py-3 flex items-center gap-3">
      <div className="flex flex-col items-center shrink-0">
        <BatteryCharging size={20} className="text-primary" />
        <span className="text-[14px] font-semibold mt-0.5">{currentRange} km</span>
      </div>
